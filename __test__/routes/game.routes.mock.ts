export const RESPONSE_GET_MOCK = {
  game_1: {
    totalKills: 0,
    players: ['Isgalamido'],
    kills: { Isgalamido: 0 },
...
export const RESPONSE_GET_BY_ID_MOCK = {
  totalKills: 0,
  players: ['Isgalamido'],
  kills: {
    Isgalamido: 0,
...
export const RESPONSE_POST_MOCK = {
  status: 201,
  message: 'Success!',
};

export const ERROR_GET_BY_ID_MOCK = {
  status: 400,
  message: 'Game does not exist! There are only 21 games',
};
